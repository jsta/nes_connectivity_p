...
```{r 04_global_vollenweider, echo=FALSE, fig.cap="Residence time (yr) versus P retention for the NES dataset and the global model fit to the data where the solid line and shaded interval represents the median and central 95% interval estimates respectively.", warning=FALSE, fig.width = 3.5, fig.height = 3.2}

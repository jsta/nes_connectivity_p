...
GGally::ggpairs(columns = c("Average Link Length", 
...
ggplot(data = nes_nws) + 
  geom_point(aes(x = avg_link_length, y = stream_density)) + 
  ylab("Stream density") + xlab("Average Link Length")
```

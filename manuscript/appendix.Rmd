...
test <- elevatr::get_elev_raster(as_Spatial(iws), z = 8)
test2 <- crop(test, nws)

plot(test2)
plot(iws$geometry, add = TRUE)
plot(nws$geometry, add = TRUE)

test3 <- as.matrix(test2)
test4 <- rayshader::rayshade(test3, 
...
ggplot(data = reshape2::melt(test4)) + 

...
\begin{figure} \ContinuedFloat
  \begin{center}
    ...
    \caption{\textbf{Table 1. } Minimum, median, maximum, and interquartile range of selected characteristics of the study lakes (N = 129).}\label{table1}    
  \end{center}
\end{figure}

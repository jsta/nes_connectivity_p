...
[Rcpp](http://dirk.eddelbuettel.com/code/rcpp.html) by \cite{cardilleCarbonWaterCycling2007} 
...
. The conversion from markdown to latex is facilitated by
[rmarkdown](https://cran.r-project.org/package=rmarkdown)
 and [knitr](https://cran.r-project.org/package=knitr)
\citep{cardilleCarbonWaterCycling2007}. The underlying LaTeX macros are from

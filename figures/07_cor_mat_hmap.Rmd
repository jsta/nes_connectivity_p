...
```{r 07_cor_mat_hmap, echo=FALSE, warning=FALSE, fig.width=4, fig.height=3.7, fig.cap="Correlation between connectivity metrics and selected lake characteristics.", message=FALSE}

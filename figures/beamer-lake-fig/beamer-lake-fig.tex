...
\begin{columns}
  ...
  \begin{column}{0.7\textwidth}
    \begin{tikzpicture}[scale = #1]
      ...
      (3,-1.2) -- (3,7.2) node [cyan,midway,xshift=1.3cm] {\footnotesize
      Lake \\ \footnotesize Watershed\\ \footnotesize 3};
      
      \draw [cyan, thick, decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt, align=center, anchor=center]
      (5.4,-1.2) -- (5.4,9) node [cyan,midway,xshift=1.3cm] {\footnotesize
      Lake \\ \footnotesize Network \\ \footnotesize Watershed\\ \footnotesize 3};
      
      \draw [darkgreen, thick, decorate, decoration={brace,amplitude=10pt,raise=4pt},yshift=0pt]
      (-3.1,3) -- (-3.1,7.2) node [darkgreen,midway,xshift=-1.3cm, align=center] {\footnotesize
      ...
      (-5.5,3) -- (-5.5,9) node [darkgreen,midway,xshift=-1.3cm, align=center] {\footnotesize
      Lake \\ \footnotesize
      Network \\ \footnotesize Watershed\\ \footnotesize 2};

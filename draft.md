...
![Conceptual diagram where the degree of shading indicates P retention. At the IWS scale lake connectivity metrics play a larger role than stream connecitivty metrics in determining P retention. Lake connectivity metrics are also important at the NWS scale but metrics that reflect lake characteristics such as area become less important than lake characteristics that represent regional configuration such as closest distance to upstream lake.](figures/conceptual_diagram.png){ width=85% }

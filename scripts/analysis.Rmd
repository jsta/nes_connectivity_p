...
```{r table_2, echo=FALSE, fig.cap="Table 2"}

```

```{r table_3, echo=FALSE, fig.cap="Table 3"}
...
```{r fig.cap="Connectivity metric box"}
knitr::include_graphics("../figures/conny_metric_key.pdf")
```
...
RUN DEBIAN_FRONTEND=noninteractive apt-get update -qq && DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends grass-dev p7zip-full curl texlive-base texlive-extra-utils 
